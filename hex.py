...
if __name__ == "__main__":
  ...
  # Create three phones in the area
  phone_dict = {
    'a': Phone('A', (10, 10)),
  ...
  while True:
    for event in pygame.event.get(): 
      if event.type == pygame.QUIT: 
        ...
        # If the user selects one of the letters associated to labels of the
        #  phones, then we assume the user is wanting to select a different
        #  phone as the currently selected phone.
